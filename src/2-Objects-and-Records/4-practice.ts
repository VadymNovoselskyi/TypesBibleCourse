...
export type OptionalizeTimestamp<T extends { timestamp: unknown }> = Omit<T, "timestamp"> &
  Partial<Pick<T, "timestamp">>;
...
type test2 = Expect<Equal<result2, { timestamp?: Date } & { url: string; status: number }>>;
