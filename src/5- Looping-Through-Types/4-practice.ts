...
type SyncReadings<Streams> = Streams extends [Array<infer U>, ...infer Tail]
  ? [U, ...SyncReadings<Tail>]
  : [];
...
const syncResult2 = synchronizeSensors([25, 26], [false, true], ["high", "low"]);
...
const syncResult3 = synchronizeSensors([15, 20, null], [true, false, undefined]);
// Expected type: [number | null, boolean | undefined][]
type testSync3 = Expect<Equal<typeof syncResult3, [number | null, boolean | undefined][]>>;
