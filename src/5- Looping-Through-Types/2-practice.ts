...
type ExtractResults<Ops extends any[]> = Ops extends [Promise<infer R>, ...infer Tail]
  ? [R, ...ExtractResults<Tail>]
  : [];
...
const resultA = gatherAsync(Promise.resolve(42), Promise.resolve("Completed" as const));
