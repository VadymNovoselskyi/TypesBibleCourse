...
type FilterTupleByType<Tuple, Target> = Tuple extends [infer Head, ...infer Tail]
  ? [...(Head extends Target ? [Head] : []), ...FilterTupleByType<Tail, Target>]
  : [];
...
type configValues2 = FilterTupleByType<["host", 8080, "protocol", true, "path"], string>;
...
type configValues3 = FilterTupleByType<["env", null, 42, { mode: "prod" }, [], undefined], {}>;
