...
type FilterSensors<SensorList, AllowedTypes> = SensorList extends [infer Head, ...infer Tail]
  ? Head extends { type: AllowedTypes }
    ? [Head, ...FilterSensors<Tail, AllowedTypes>]
    : FilterSensors<Tail, AllowedTypes>
  : [];
/**
...
>(sensors: Sensors, allowedTypes: AllowedTypes[]): FilterSensors<Sensors, AllowedTypes>;
